...
impl TextAtlas {
    ...
    pub fn with_color_mode(
        ...
        let color_atlas = InnerAtlas::new(device, queue, Kind::Color {
    ...
    pub(crate) fn glyph(&self, glyph: &CacheKey) -> Option<&GlyphDetails> {
        self.mask_atlas.glyph_cache.peek(glyph).or_else(|| self.color_atlas.glyph_cache.peek(glyph))
    }
    ...
    pub(crate) fn get_or_create_pipeline(
        ...
        self.cache.get_or_create_pipeline(device, self.format, multisample, depth_stencil)
    }
